...
module.exports = async (client, message) => {
	...
	if(message.content == '<@!763458047505858571>') return message.channel.send(`Мой префикс на данном сервере: \`${guild.prefix}\`	`);
	...
	if(command.ownerOnly && message.author.id != '724335588635050014') return;
	try {
